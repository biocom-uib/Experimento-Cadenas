...
La función `base.predominante` siguiente genera una cadena de longitud 1000 del `tipo` entrado como argumento y calcula su base de frecuencia máxima (si hay empate escoge una al azar):
